...
%type <node>	fetch_args select_limit_value
				...
				select_fetch_first_value I_or_F_const opt_flashback_window_clause
...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	VERBOSE VERSION_P VERSIONS VIEW VIEWS VOLATILE
 ...
 */
%token		NOT_LA NULLS_LA WITH_LA AS_LA VERSIONS_LA
...
alter_table_cmd:
			...
			/* ALTER TABLE <name> ENABLE FLASHBACK */
			| ENABLE_P FLASHBACK
				{
					AlterTableCmd *n = makeNode(AlterTableCmd);
					n->subtype = AT_EnableFlashback;
					$$ = (Node *)n;
				}
 ...
 */
table_ref:	relation_expr opt_alias_clause opt_flashback_window_clause
				{
					$1->alias = $2;
					$1->flashback_window = (FlashbackWindow *) $3;
					$$ = (Node *) $1;
				}
...
opt_flashback_window_clause: 
			AS_LA OF TIMESTAMP a_expr
				{
					FlashbackWindow *flashback_window = (FlashbackWindow *) makeNode(FlashbackWindow);
					flashback_window->flashback_query_type = FLASHBACK_QUERY_ASOF_TIMESTAMP;
					flashback_window->flashback_timestamp_min = $4;
					flashback_window->flashback_timestamp_max = $4;
					$$ = (Node *) flashback_window;
				}
			| VERSIONS_LA BETWEEN TIMESTAMP b_expr AND a_expr
				{
					FlashbackWindow *flashback_window = (FlashbackWindow *) makeNode(FlashbackWindow);
					flashback_window->flashback_query_type = FLASHBACK_QUERY_VERSIONS_BETWEEN_TIMESTAMP;
					flashback_window->flashback_timestamp_min = $4;
					flashback_window->flashback_timestamp_max = $6;
					$$ = (Node *) flashback_window;
				}
			| /*EMPTY*/								{ $$ = NULL; }
		;
